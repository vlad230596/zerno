...
export const en: typeof ru = {
  ...
  rules: {
    ...
    excludedTitle: 'Excluded from rules',
    excludedCount_one: '{{count}} operation is excluded from the rules',
    excludedCount_few: '{{count}} operations are excluded from the rules',
    excludedCount_many: '{{count}} operations are excluded from the rules',
    excludedCount_other: '{{count}} operations are excluded from the rules',
    excludedHint: 'Their category was set by hand, so rules leave it alone.',
    excludedShow: 'Show',
    excludedReset: 'Hand back to the rules',
    excludedResetConfirm_one: 'Hand {{count}} operation back to the rules?',
    excludedResetConfirm_few: 'Hand {{count}} operations back to the rules?',
    excludedResetConfirm_many: 'Hand {{count}} operations back to the rules?',
    excludedResetConfirm_other: 'Hand {{count}} operations back to the rules?',
    excludedResetOk: 'Hand back',
    noTags: 'No category',
    edit: 'Edit',
    delete: 'Delete',
  ...
  balance: {
    ...
    untaggedTitle: 'Uncategorized by month',
    untaggedTotal_one: '{{count}} in a year',
    untaggedTotal_few: '{{count}} in a year',
    untaggedTotal_many: '{{count}} in a year',
    untaggedTotal_other: '{{count}} in a year',
